...
public class Utility {
	...
	public static Integer MonthlyBill = 0;
	public static Integer AnnualBill = 1;
	public static Integer WeeklyBill = 2;
	public static Integer OneTimeBill = 3;
	public static Integer LimitedBill = 4;
